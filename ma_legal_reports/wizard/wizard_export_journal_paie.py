...
class WizardExportJournalPaie(models.TransientModel):
    ...
    def button_confirm(self):
        ...
        rubriques_employee = ['Retenue CNSS Employee', 'Rappel sur salaire AMO Employee', 'Prime de responsabilité Employee', 'Indemnité. de transport Employee',
                               ...
                               'Prime production VIP REV Employee', 'Prime de permanence Employee', 'Mutuelle décès Employee', 'Complément salaire MD/AT Employee',
                               ...
                               'Prime départ retraite Employee', 'Rappel sur salaire Employee', 'Avance sur salaire Employee', 'Heures à déduire Employee', 
                               'Retraite  complémentaire RECORE Employee', 'Cotisation MUPRAS Employee', 'Retenue CIMR Employee', 'CIMR 4,5 Employee'
                               ] 
        
        rubriques_employeur = ['Retenue CNSS Employeur','Décès accidentel Employeur', 'Taxe de formation professionnelle Employeur', 'Retenue CIMR Employeur',
                               ...
                               'Retraite complémentaire RECORE Employeur','Mutuelle décès Employeur','Bonus Employeur', 'Prêt logement Employeur',
                               ...
                               'Heures à déduire Employeur', 'Retraite  complémentaire RECORE Employeur', 'Cotisation MUPRAS Employeur', 'Retenue CIMR Employeur', 'CIMR 4,5 Employeur'
                               ]
        ...
        for payroll in active_recs:
            ...
            for line in payroll.bulletin_line_ids:
                ...
                jours_travaillés = line.working_days if line.working_days else 0.0
                worksheet.write(row,5,jours_travaillés,cell_style_body_tab)
                conges_payes = line.conges_payes if line.conges_payes else 0.0
                worksheet.write(row,6,conges_payes,cell_style_body_tab)
                ...
                cotisations_employé = line.cotisations_employee if line.cotisations_employee else 0.0
                worksheet.write(row,14,cotisations_employé,cell_style_body_tab)
                total_cotisations_employé += line.cotisations_employee
        ...
        worksheet.write(row,14,total_cotisations_employé,cell_style_header_tab)
